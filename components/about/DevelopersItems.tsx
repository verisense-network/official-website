...
const Item = () => {
  return (
    <div className="text-white md:w-[570px] md:mt-[60px] pl-3 md:pl-0 ">
      <div className="text-[22px] text-[#ff847c] font-medium">DEVELOPERS</div>
      ...
      <div className="text-[12px] md:text-[18px] font-light mt-[30px] leading-[28px] md:leading-[38px]">
        Safeguard your validation network altogether across
      </div>
      <div className="text-[12px] md:text-[18px] font-light leading-[28px] md:leading-[38px]">
