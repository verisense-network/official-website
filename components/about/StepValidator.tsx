...
const StepValidator = () => {
  return (
    <>
      <div className="flex flex-col lg:hidden w-[370px] lg:h-[380px] justify-center items-center  px-3 lg:px-auto">
        <div className="flex items-center justify-center">
          <span className="inline-block w-[12px] h-[12px] bg-[#595959] rounded-full" />
          <span className="inline-block w-[150px] lg:w-[160px] h-[3px] bg-gradient-to-b from-[#595959] to-white" />
        ...
        <div className="flex text-white/70 text-[12px] lg:text-[16px] font-medium w-full items-center mt-1">
          ...
          <span className="inline-block">Validation-as-a-Service</span>
        </div>
      </div>
      <div className="hidden lg:flex w-[150px] h-[380px] justify-center">
        <div className="flex flex-col items-center">
          <span className="inline-block w-[12px] h-[12px] bg-[#595959] rounded-full" />
          <span className="inline-block w-[3px] h-[160px]  bg-gradient-to-b from-[#595959] to-white " />
          <span className="inline-block w-[12px] h-[12px] bg-white  rounded-full" />
...
export default React.memo(StepValidator);
